...
// (03) Copy over the different buzz pattern Long array constants here
...
class GameViewModel : ViewModel() {
    ...
    // (04) Make an enum called BuzzType - have a different buzz type for CORRECT, GAME_OVER
    ...
    companion object {
        ...
        //starts buzzing at this remaining time
        private const val BUZZ_TIME = 10L
    ...
    // (05) Create a properly encapsulated LiveData for a buzz event - its' type should be
    // BuzzType
    ...
    init {
        ...
        timer = object : CountDownTimer(COUNTDOWN_TIME, ONE_SECOND) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                if (millisUntilFinished/ ONE_SECOND <= BUZZ_TIME){
